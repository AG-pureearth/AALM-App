...
(function () {
  ...
  const STEPS = [
    ...
    { sel: "#f-simname", tab: "inputs", title: "Step 1 — Set your simulation parameters",
      text: "Name your run (letters, numbers, or underscores — for example City_Test1), then set the simulation parameters that describe the person you’re modeling." },
    { sel: '[data-tour="sim"]', tab: "inputs", title: "Step 2 — Set the age and sex",
      text: "Set the start and end age (in years) and the sex — these describe the person you’re modeling, so you should choose them yourself. The other settings on this tab can usually be left at their defaults." },
